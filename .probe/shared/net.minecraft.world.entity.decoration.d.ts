...
import { $Component, $Component$$Type } from "net.minecraft.network.chat.Component"
import { $PartEntity } from "net.minecraftforge.entity.PartEntity"
import { $ArmorStandAccessor } from "io.redspace.ironslib.mixin.ArmorStandAccessor"
import { $RayTraceResultJS } from "dev.latvian.mods.kubejs.entity.RayTraceResultJS"
...
export class $ArmorStand extends $LivingEntity implements $ArmorStandAccessor, $ISupportTransmog, $EquipmentEntity$EquipmentTrackingEntity, $EquipmentEntity {
...
public "getType"(): string
public "handler$fod000$onInteractAt"(player: $Player$$Type, vec3: $Vec3$$Type, interactionHand: $InteractionHand$$Type, cir: $CallbackInfoReturnable$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
...
import { $EntityType$$Type } from "net.minecraft.world.entity.EntityType"
import { $Direction, $Direction$$Type } from "net.minecraft.core.Direction"
import { $ItemFrameAccessor } from "com.simibubi.create.foundation.mixin.accessor.ItemFrameAccessor"
import { $GameProfile } from "com.mojang.authlib.GameProfile"
import { $BlockState$$Type } from "net.minecraft.world.level.block.state.BlockState"
import { $FluidType$$Type } from "net.minecraftforge.fluids.FluidType"
