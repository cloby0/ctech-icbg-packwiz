...
import { $INearbyItemAwareEntity } from "com.leaky.INearbyItemAwareEntity"
...
import { $ItemEntityAccessor } from "vazkii.botania.mixin.ItemEntityAccessor"
...
export class $ItemEntity extends $Entity implements $TraceableEntity, $INearbyItemAwareEntity, $ItemEntityAccessor, $ItemEntityKJS, $ItemEntityAccess, $LycheeCounter {
static readonly "INFINITE_PICKUP_DELAY": integer
...
public "handler$bcc000$celestial_core$tick$recipe"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$ddd004$adastra$tick"(ci: $CallbackInfo$$Type): void
public "handler$edm000$Cmhurt"(damageSource0: $DamageSource$$Type, float1: float, callbackInfoReturnable2: $CallbackInfoReturnable$$Type): void
public "handler$gda000$beforeTick"(callbackInfo0: $CallbackInfo$$Type): void
...
public "redirect$hic000$protectSpellbook"(itemEntity0: $ItemEntity$$Type, damageSource1: $DamageSource$$Type): boolean
...
public "setNearbyItems"(int0: integer): void
...
import { $ScriptType } from "dev.latvian.mods.kubejs.script.ScriptType"
import { $Player$$Type } from "net.minecraft.world.entity.player.Player"
import { $FallingBlockEntityAccessor } from "com.simibubi.create.foundation.mixin.accessor.FallingBlockEntityAccessor"
import { $HitResult$$Type } from "net.minecraft.world.phys.HitResult"
import { $EntityArrayList } from "dev.latvian.mods.kubejs.player.EntityArrayList"
import { $Entity, $Entity$$Type } from "net.minecraft.world.entity.Entity"
import { $CompoundTag, $CompoundTag$$Type } from "net.minecraft.nbt.CompoundTag"
...
export class $FallingBlockEntity extends $Entity implements $LycheeFallingBlockEntity, $FallingBlockEntityAccessor {
...
public "getTeamId"(): string
public "getType"(): string
public "handler$ehp000$handleLand"(ci: $CallbackInfo$$Type, block: $Block$$Type, blockPos2: $BlockPos$$Type, bl: boolean, bl2: boolean, d: double, blockState: $BlockState$$Type): void
public "handler$gnk000$stopTickingIfRemoved"(callbackInfo0: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabled"(): boolean
...
public static "makeBasicContainer"<O, T extends $TrackedData<O>>(registry: $TrackedDataRegistry$$Type<O, T>, o: O, isClient: boolean, lazyLoad: boolean): $TrackedDataContainer<O, T>
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "modify$hdb000$supplementaries$concreteFix"(original: $BlockPos$$Type): $BlockPos
public "playSound"(id: $SoundEvent$$Type): void
public "playSound"(id: $SoundEvent$$Type, volume: float, pitch: float): void
public "rayTrace"(distance: double): $RayTraceResultJS
public "rayTrace"(distance: double, fluids: boolean): $RayTraceResultJS
...
import { $BlockState$$Type } from "net.minecraft.world.level.block.state.BlockState"
import { $FluidType$$Type } from "net.minecraftforge.fluids.FluidType"
import { $PrimedTntAccessor } from "com.gregtechceu.gtceu.core.mixins.PrimedTntAccessor"
import { $LazyOptional } from "net.minecraftforge.common.util.LazyOptional"
import { $TrackedData, $TrackedData$$Type } from "dev.corgitaco.dataanchor.data.TrackedData"
import { $BlockContainerJS, $BlockContainerJS$$Type } from "dev.latvian.mods.kubejs.level.BlockContainerJS"
import { $CallbackInfo$$Type } from "org.spongepowered.asm.mixin.injection.callback.CallbackInfo"
...
export class $PrimedTnt extends $Entity implements $TraceableEntity, $DynamicLightSource, $PrimedTntAccessor {
