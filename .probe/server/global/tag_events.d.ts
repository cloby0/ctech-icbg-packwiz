...
function tags(extra: "botania:brews", handler: ((event: TagEventProbe<Special.Botania$BrewsTag, Special.Botania$Brews>) => void)): void
function tags(extra: "hexcasting:iota_type", handler: ((event: TagEventProbe<Special.Hexcasting$IotaTypeTag, Special.Hexcasting$IotaType>) => void)): void
...
function tags(extra: "hexcasting:eval_sound", handler: ((event: TagEventProbe<Special.Hexcasting$EvalSoundTag, Special.Hexcasting$EvalSound>) => void)): void
function tags(extra: "create:display_source", handler: ((event: TagEventProbe<Special.Create$DisplaySourceTag, Special.Create$DisplaySource>) => void)): void
function tags(extra: "create:potato_projectile/block_hit_action", handler: ((event: TagEventProbe<Special.Create$PotatoProjectileBlockHitActionTag, Special.Create$PotatoProjectileBlockHitAction>) => void)): void
function tags(extra: "hexcasting:special_handler", handler: ((event: TagEventProbe<Special.Hexcasting$SpecialHandlerTag, Special.Hexcasting$SpecialHandler>) => void)): void
function tags(extra: "create:potato_projectile/render_mode", handler: ((event: TagEventProbe<Special.Create$PotatoProjectileRenderModeTag, Special.Create$PotatoProjectileRenderMode>) => void)): void
function tags(extra: "create:display_target", handler: ((event: TagEventProbe<Special.Create$DisplayTargetTag, Special.Create$DisplayTarget>) => void)): void
function tags(extra: "create:contraption_type", handler: ((event: TagEventProbe<Special.Create$ContraptionTypeTag, Special.Create$ContraptionType>) => void)): void
function tags(extra: "create:mounted_item_storage_type", handler: ((event: TagEventProbe<Special.Create$MountedItemStorageTypeTag, Special.Create$MountedItemStorageType>) => void)): void
function tags(extra: "create:arm_interaction_point_type", handler: ((event: TagEventProbe<Special.Create$ArmInteractionPointTypeTag, Special.Create$ArmInteractionPointType>) => void)): void
function tags(extra: "create:fan_processing_type", handler: ((event: TagEventProbe<Special.Create$FanProcessingTypeTag, Special.Create$FanProcessingType>) => void)): void
function tags(extra: "create:mounted_fluid_storage_type", handler: ((event: TagEventProbe<Special.Create$MountedFluidStorageTypeTag, Special.Create$MountedFluidStorageType>) => void)): void
function tags(extra: "hexcasting:continuation_type", handler: ((event: TagEventProbe<Special.Hexcasting$ContinuationTypeTag, Special.Hexcasting$ContinuationType>) => void)): void
...
function tags(extra: "hexcasting:action", handler: ((event: TagEventProbe<Special.Hexcasting$ActionTag, Special.Hexcasting$Action>) => void)): void
...
function tags(extra: "create:potato_projectile/entity_hit_action", handler: ((event: TagEventProbe<Special.Create$PotatoProjectileEntityHitActionTag, Special.Create$PotatoProjectileEntityHitAction>) => void)): void
function tags(extra: "hexcasting:arithmetic", handler: ((event: TagEventProbe<Special.Hexcasting$ArithmeticTag, Special.Hexcasting$Arithmetic>) => void)): void
function tags(extra: "create:item_attribute_type", handler: ((event: TagEventProbe<Special.Create$ItemAttributeTypeTag, Special.Create$ItemAttributeType>) => void)): void
function tags(extra: "aether:advancement_sound_override", handler: ((event: TagEventProbe<Special.Aether$AdvancementSoundOverrideTag, Special.Aether$AdvancementSoundOverride>) => void)): void
function tags(extra: "aether:moa_type", handler: ((event: TagEventProbe<Special.Aether$MoaTypeTag, Special.Aether$MoaType>) => void)): void
function tags(extra: "createbigcannons:block_recipe_serializers", handler: ((event: TagEventProbe<Special.Createbigcannons$BlockRecipeSerializersTag, Special.Createbigcannons$BlockRecipeSerializers>) => void)): void
function tags(extra: "createbigcannons:block_recipe_types", handler: ((event: TagEventProbe<Special.Createbigcannons$BlockRecipeTypesTag, Special.Createbigcannons$BlockRecipeTypes>) => void)): void
function tags(extra: "createbigcannons:cannon_cast_shapes", handler: ((event: TagEventProbe<Special.Createbigcannons$CannonCastShapesTag, Special.Createbigcannons$CannonCastShapes>) => void)): void
...
function tags(extra: "libx:biome_surface", handler: ((event: TagEventProbe<Special.Libx$BiomeSurfaceTag, Special.Libx$BiomeSurface>) => void)): void
...
function tags(extra: "libx:template_pool_extension", handler: ((event: TagEventProbe<Special.Libx$TemplatePoolExtensionTag, Special.Libx$TemplatePoolExtension>) => void)): void
...
function tags(extra: "vista:cassette_tape", handler: ((event: TagEventProbe<Special.Vista$CassetteTapeTag, Special.Vista$CassetteTape>) => void)): void
...
function tags(extra: "create:potato_projectile/type", handler: ((event: TagEventProbe<Special.Create$PotatoProjectileTypeTag, Special.Create$PotatoProjectileType>) => void)): void
function tags(extra: "libx:biome_layer", handler: ((event: TagEventProbe<Special.Libx$BiomeLayerTag, Special.Libx$BiomeLayer>) => void)): void
function tags(extra: "libx:surface_rule_set", handler: ((event: TagEventProbe<Special.Libx$SurfaceRuleSetTag, Special.Libx$SurfaceRuleSet>) => void)): void
}
}
