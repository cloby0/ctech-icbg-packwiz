...
ServerEvents.recipes(event => {
    ...
    addEnchantingRecipe(event, { reagent: [{ item: 'nameless_trinkets:ultimate_dust' }], output: { item: 'morerelics:crown_of_the_legend' }, sourceCost: 25000, pedestalItems: [{item:{item:'botania:gaia_ingot'}},{item:{item:'botania:gaia_ingot'}},{item:{item:'botania:terrasteel_ingot'}},{item:{item:'botania:terrasteel_ingot'}},{item:{item:'minecraft:nether_star'}},{tag:'forge:ingots/elementium'}] }, index++)
    ...
    addEnchantingRecipe(event, { reagent: [{ item: 'irons_spellbooks:netherite_spell_book' }], output: { item: 'kubejs:evocation_folio' }, sourceCost: 30000, pedestalItems: [{item:{item:'gtceu:prima_materia_ingot'}},{item:{item:'gtceu:prima_materia_ingot'}},{item:{item:'kubejs:chaos_essence'}},{item:{item:'irons_spellbooks:evocation_rune'}},{item:{item:'irons_spellbooks:evocation_rune'}},{item:{item:'minecraft:nether_star'}}] }, index++)

    // ironsSpellbooks.js — Arcanist spellbooks
    addEnchantingRecipe(event, { reagent: [{ item: 'irons_spellbooks:netherite_spell_book' }], output: { item: 'kubejs:glacial_grimoire' }, sourceCost: 40000, pedestalItems: [{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{item:{item:'kubejs:elven_concentrate'}},{item:{item:'kubejs:elven_concentrate'}},{item:{item:'irons_spellbooks:ice_rune'}},{item:{item:'irons_spellbooks:ice_rune'}}] }, index++)
    addEnchantingRecipe(event, { reagent: [{ item: 'irons_spellbooks:netherite_spell_book' }], output: { item: 'kubejs:verdant_chronicle' }, sourceCost: 40000, pedestalItems: [{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{tag:'forge:ingots/elementium'},{item:{item:'kubejs:elven_concentrate'}},{item:{item:'kubejs:elven_concentrate'}},{item:{item:'irons_spellbooks:nature_rune'}},{item:{item:'irons_spellbooks:nature_rune'}}] }, index++)
    ...
    addEnchantingRecipe(event, { reagent: [{ item: 'kubejs:gaian_holy_core' }], output: { item: 'kubejs:gaian_sanctum' }, sourceCost: 50000, pedestalItems: [{item:{item:'botania:gaia_ingot'}},{item:{item:'botania:gaia_ingot'}},{item:{item:'irons_spellbooks:divine_pearl'}},{item:{item:'irons_spellbooks:divine_pearl'}},{item:{item:'irons_spellbooks:divine_pearl'}},{item:{item:'irons_spellbooks:divine_pearl'}},{item:{item:'minecraft:golden_apple'}},{item:{item:'minecraft:golden_apple'}}] }, index++)
    addEnchantingRecipe(event, { reagent: [{ item: 'kubejs:gaian_void_core' }], output: { item: 'kubejs:abyssal_codex' }, sourceCost: 50000, pedestalItems: [{item:{item:'botania:gaia_ingot'}},{item:{item:'botania:gaia_ingot'}},{item:{item:'minecraft:nether_star'}},{item:{item:'minecraft:nether_star'}},{item:{item:'minecraft:ender_eye'}},{item:{item:'minecraft:ender_eye'}},{item:{item:'minecraft:ender_eye'}},{item:{item:'minecraft:ender_eye'}}] }, index++)
