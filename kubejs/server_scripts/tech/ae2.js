ServerEvents.recipes(event => {
    ...
    event.remove({ output: 'ae2:1k_me_storage_cell' })
    event.remove({ output: 'ae2:4k_me_storage_cell' })
    event.remove({ output: 'ae2:16k_me_storage_cell' })
    event.remove({ output: 'ae2:64k_me_storage_cell' })
    event.remove({ output: 'ae2:256k_me_storage_cell' })
