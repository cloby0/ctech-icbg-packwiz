...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('pistol_frame_lv')
        .itemInputs('2x gtceu:wrought_iron_plate', 'gtceu:wrought_iron_bolt', 'gtceu:wrought_iron_ring', 'gtceu:wrought_iron_screw', 'gtceu:wrought_iron_spring')
    ...
    event.recipes.gtceu.assembler('pistol_frame_hv')
        .itemInputs('2x gtceu:stainless_steel_plate', 'gtceu:stainless_steel_bolt', 'gtceu:stainless_steel_ring', '2x gtceu:stainless_steel_screw', 'gtceu:stainless_steel_spring')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('pistol_frame_ev')
        .itemInputs('2x gtceu:titanium_plate', '2x gtceu:titanium_bolt', 'gtceu:titanium_ring', '2x gtceu:titanium_screw', 'gtceu:titanium_spring')
    ...
    event.recipes.gtceu.assembler('pistol_frame_iv')
        .itemInputs('3x gtceu:titanium_plate', '2x gtceu:titanium_bolt', 'gtceu:titanium_ring', '2x gtceu:titanium_screw', 'gtceu:titanium_spring')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('rifle_receiver_lv')
        .itemInputs('3x gtceu:wrought_iron_plate', '2x gtceu:wrought_iron_bolt', 'gtceu:wrought_iron_ring', '2x gtceu:wrought_iron_screw', 'gtceu:wrought_iron_spring')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('rifle_receiver_hv')
        .itemInputs('3x gtceu:stainless_steel_plate', '2x gtceu:stainless_steel_bolt', 'gtceu:stainless_steel_ring', '2x gtceu:stainless_steel_screw', 'gtceu:stainless_steel_spring')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('rifle_receiver_iv')
        .itemInputs('4x gtceu:titanium_plate', '3x gtceu:titanium_bolt', '2x gtceu:titanium_ring', '3x gtceu:titanium_screw', '2x gtceu:titanium_spring')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('heavy_frame_lv')
        .itemInputs('4x gtceu:wrought_iron_plate', '2x gtceu:wrought_iron_bolt', 'gtceu:wrought_iron_ring', '2x gtceu:wrought_iron_screw', 'gtceu:wrought_iron_spring', 'gtceu:wrought_iron_gear')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('heavy_frame_hv')
        .itemInputs('4x gtceu:stainless_steel_plate', '2x gtceu:stainless_steel_bolt', 'gtceu:stainless_steel_ring', '2x gtceu:stainless_steel_screw', 'gtceu:stainless_steel_spring', 'gtceu:stainless_steel_gear')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('heavy_frame_ev')
        .itemInputs('4x gtceu:titanium_plate', '2x gtceu:titanium_bolt', '2x gtceu:titanium_ring', '2x gtceu:titanium_screw', '2x gtceu:titanium_spring', 'gtceu:titanium_gear')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('heavy_frame_iv')
        .itemInputs('6x gtceu:titanium_plate', '3x gtceu:titanium_bolt', '2x gtceu:titanium_ring', '3x gtceu:titanium_screw', '2x gtceu:titanium_spring', 'gtceu:titanium_gear')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('long_barrel_lv')
        .itemInputs('kubejs:lv_long_barrel_blank', 'gtceu:wrought_iron_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('long_barrel_mv')
        .itemInputs('kubejs:mv_long_barrel_blank', 'gtceu:steel_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('long_barrel_hv')
        .itemInputs('kubejs:hv_long_barrel_blank', 'gtceu:stainless_steel_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 100))
    ...
    event.recipes.gtceu.assembler('long_barrel_ev')
        .itemInputs('kubejs:ev_long_barrel_blank', 'gtceu:titanium_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('long_barrel_iv')
        .itemInputs('kubejs:iv_long_barrel_blank', 'gtceu:titanium_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 200))
    ...
    event.recipes.gtceu.assembler('long_barrel_luv')
        .itemInputs('kubejs:luv_long_barrel_blank', 'gtceu:naquadah_alloy_small_pipe')
        .inputFluids(Fluid.of('gtceu:lubricant', 500))
    ...
    event.recipes.gtceu.assembler('gun_fire_control_lv')
        .itemInputs('gtceu:wrought_iron_bolt', '2x gtceu:wrought_iron_ring', 'gtceu:wrought_iron_spring')
    ...
    event.recipes.gtceu.assembler('gun_fire_control_hv')
        .itemInputs('gtceu:stainless_steel_bolt', '2x gtceu:stainless_steel_ring', 'gtceu:stainless_steel_spring', '4x gtceu:fine_gold_wire', '#gtceu:circuits/mv')
        .itemOutputs('1x kubejs:hv_gun_fire_control')
        .duration(100)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('gun_fire_control_ev')
        .itemInputs('gtceu:titanium_bolt', '2x gtceu:titanium_ring', 'gtceu:titanium_spring', '4x gtceu:fine_aluminium_wire', '#gtceu:circuits/hv')
        .itemOutputs('1x kubejs:ev_gun_fire_control')
        .duration(100)
        .EUt(GTValues.VA[GTValues.EV])

    event.recipes.gtceu.assembler('gun_fire_control_iv')
        .itemInputs('2x gtceu:titanium_bolt', '3x gtceu:titanium_ring', '2x gtceu:titanium_spring', '8x gtceu:fine_aluminium_wire', '#gtceu:circuits/ev')
