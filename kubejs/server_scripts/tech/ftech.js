ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('ftech_copper_drill')
        .itemInputs('4x create:copper_sheet', 'gtceu:mv_electric_motor', 'gtceu:copper_rod', '#gtceu:circuits/mv')
        .inputFluids(Fluid.of('gtceu:soldering_alloy', 72))
    ...
    event.recipes.gtceu.assembler('ftech_iron_drill')
        .itemInputs('4x create:iron_sheet', 'gtceu:mv_electric_motor', 'gtceu:steel_rod', '#gtceu:circuits/mv')
        .inputFluids(Fluid.of('gtceu:soldering_alloy', 72))
    ...
    event.recipes.gtceu.assembler('ftech_gold_drill')
        .itemInputs('4x create:golden_sheet', 'gtceu:mv_electric_motor', 'gtceu:gold_rod', '#gtceu:circuits/mv')
        .inputFluids(Fluid.of('gtceu:soldering_alloy', 72))
