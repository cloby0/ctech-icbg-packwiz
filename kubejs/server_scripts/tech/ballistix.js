ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.arms_manufacturer('ballistix_thermobaric')
        .itemInputs('2x ballistix:chemical', '2x ballistix:incendiary', '2x ballistix:breaching', '2x ballistix:repulsive', '4x gtceu:titanium_plate', '2x #gtceu:circuits/iv')
    ...
    event.recipes.gtceu.arms_manufacturer('ballistix_emp')
        .itemInputs('8x gtceu:fine_cupronickel_wire', '4x gtceu:naquadah_plate', 'ballistix:condensive', '4x #gtceu:circuits/luv')
        .inputFluids(Fluid.of('gtceu:soldering_alloy', 576))
    ...
    event.recipes.gtceu.arms_manufacturer('ballistix_rejuvination')
        .itemInputs('ballistix:condensive', '4x minecraft:bone_meal', '4x gtceu:naquadah_plate', '2x #gtceu:circuits/luv', 'botania:terrasteel_ingot')
