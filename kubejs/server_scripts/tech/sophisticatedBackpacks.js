ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('sb_backpack')
        .itemInputs('4x minecraft:leather', '2x gtceu:rubber_plate', '4x minecraft:string')
    ...
    event.recipes.gtceu.assembler('sb_copper_backpack')
        .itemInputs('sophisticatedbackpacks:backpack', '8x gtceu:bronze_ingot')
    ...
    event.recipes.gtceu.assembler('sb_iron_backpack')
        .itemInputs('sophisticatedbackpacks:copper_backpack', '8x gtceu:steel_ingot')
    ...
    event.recipes.gtceu.assembler('sb_gold_backpack')
        .itemInputs('sophisticatedbackpacks:iron_backpack', '4x gtceu:aluminium_ingot', '4x gtceu:aluminium_plate')
    ...
    event.recipes.gtceu.assembler('sb_diamond_backpack')
        .itemInputs('sophisticatedbackpacks:gold_backpack', '4x gtceu:stainless_steel_ingot', '4x gtceu:stainless_steel_plate')
    ...
    event.recipes.gtceu.assembler('sb_netherite_backpack')
        .itemInputs('sophisticatedbackpacks:diamond_backpack', '4x gtceu:titanium_ingot', '4x gtceu:titanium_plate')
    ...
    event.recipes.gtceu.assembler('sb_upgrade_base')
        .itemInputs('2x gtceu:steel_plate', 'gtceu:rubber_plate', '4x minecraft:string')
    ...
    event.recipes.gtceu.assembler('sb_filter_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '2x gtceu:steel_plate', '2x minecraft:redstone', '2x minecraft:string')
    ...
    event.recipes.gtceu.assembler('sb_smelting_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '2x gtceu:steel_plate', '4x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:smelting_upgrade')
        .duration(10 * 20)
        .EUt(GTValues.VA[GTValues.LV])

    event.recipes.gtceu.assembler('sb_tank_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '4x minecraft:glass', '2x gtceu:steel_plate')
        .itemOutputs('sophisticatedbackpacks:tank_upgrade')
        .duration(10 * 20)
        .EUt(GTValues.VA[GTValues.LV])

    event.recipes.gtceu.assembler('sb_battery_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '2x gtceu:aluminium_plate', '2x minecraft:redstone_block')
        .itemOutputs('sophisticatedbackpacks:battery_upgrade')
        .duration(12 * 20)
        .EUt(GTValues.VA[GTValues.MV])

    event.recipes.gtceu.assembler('sb_void_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '4x minecraft:obsidian', '2x minecraft:ender_pearl', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:void_upgrade')
        .duration(12 * 20)
        .EUt(GTValues.VA[GTValues.MV])

    event.recipes.gtceu.assembler('sb_magnet_upgrade')
        .itemInputs('sophisticatedbackpacks:pickup_upgrade', '2x minecraft:ender_pearl', '2x gtceu:steel_ingot', 'minecraft:redstone', 'minecraft:lapis_lazuli')
    ...
    event.recipes.gtceu.assembler('sb_compacting_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', 'minecraft:piston', '2x gtceu:steel_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:compacting_upgrade')
        .duration(10 * 20)
        .EUt(GTValues.VA[GTValues.LV])

    event.recipes.gtceu.assembler('sb_tool_swapper_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '2x gtceu:steel_rod', 'minecraft:piston', 'minecraft:redstone')
    ...
    event.recipes.gtceu.assembler('sb_inception_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '4x minecraft:ender_eye', '2x minecraft:nether_star', '4x gtceu:stainless_steel_plate')
        .itemOutputs('sophisticatedbackpacks:inception_upgrade')
        .duration(20 * 20)
        .EUt(GTValues.VA[GTValues.EV])

    event.recipes.gtceu.assembler('sb_everlasting_upgrade')
        .itemInputs('sophisticatedbackpacks:upgrade_base', '4x minecraft:end_crystal', '2x minecraft:nether_star')
    ...
    event.recipes.gtceu.assembler('sb_advanced_pickup_upgrade')
        .itemInputs('sophisticatedbackpacks:pickup_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_pickup_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_filter_upgrade')
        .itemInputs('sophisticatedbackpacks:filter_upgrade', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_filter_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_feeding_upgrade')
        .itemInputs('sophisticatedbackpacks:feeding_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_feeding_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_void_upgrade')
        .itemInputs('sophisticatedbackpacks:void_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_void_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_magnet_upgrade')
        .itemInputs('sophisticatedbackpacks:advanced_pickup_upgrade', '2x minecraft:ender_pearl', '2x gtceu:steel_ingot', 'minecraft:redstone', 'minecraft:lapis_lazuli')
        .itemOutputs('sophisticatedbackpacks:advanced_magnet_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_compacting_upgrade')
        .itemInputs('sophisticatedbackpacks:compacting_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_compacting_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_deposit_upgrade')
        .itemInputs('sophisticatedbackpacks:deposit_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_deposit_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_restock_upgrade')
        .itemInputs('sophisticatedbackpacks:restock_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_restock_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_refill_upgrade')
        .itemInputs('sophisticatedbackpacks:refill_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:ender_pearl')
        .itemOutputs('sophisticatedbackpacks:advanced_refill_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_advanced_tool_swapper_upgrade')
        .itemInputs('sophisticatedbackpacks:tool_swapper_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:redstone')
        .itemOutputs('sophisticatedbackpacks:advanced_tool_swapper_upgrade')
        .duration(15 * 20)
        .EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.assembler('sb_auto_smelting_upgrade')
        .itemInputs('sophisticatedbackpacks:smelting_upgrade', '2x gtceu:stainless_steel_plate', '2x gtceu:aluminium_plate', '2x minecraft:hopper', '2x minecraft:redstone')
