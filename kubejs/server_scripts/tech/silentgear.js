...
// the ore/dust/ingot/block processing (macerator, washer, EBF, compressor) and OEI unifies the
// silentgear items into gtceu ones. This file only: removes silent gear's non-GT production paths,
// hand-writes the alloy mixers (mixer never autogens), and gregs the remaining infra recipes.
...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.mixer('sg_blaze_gold_dust_mix')
        ...
        .itemOutputs('1x gtceu:blaze_gold_dust')
        .duration(200).EUt(GTValues.VA[GTValues.MV])

    event.recipes.gtceu.mixer('sg_azure_electrum_dust_mix')
        .itemInputs('2x gtceu:azure_silver_dust', '2x gtceu:gold_dust', '1x minecraft:ender_pearl')
        .itemOutputs('1x gtceu:azure_electrum_dust')
        .duration(200).EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.mixer('sg_crimson_steel_dust_mix')
        .itemInputs('3x gtceu:crimson_iron_dust', '2x minecraft:blaze_rod', '1x minecraft:magma_cream')
        .itemOutputs('3x gtceu:crimson_steel_dust')
        .duration(200).EUt(GTValues.VA[GTValues.HV])

    event.recipes.gtceu.mixer('sg_tyrian_steel_dust_mix')
        .itemInputs('1x gtceu:crimson_steel_dust', '1x gtceu:azure_electrum_dust', '1x ' + SG + ':crushed_shulker_shell', '1x minecraft:netherite_scrap')
        .itemOutputs('4x gtceu:tyrian_steel_dust')
    ...
    event.recipes.gtceu.mixer('sg_starmetal_dust_mix')
        .itemInputs('1x gtceu:azure_electrum_dust', '2x gtceu:azure_silver_dust', '1x gtceu:blaze_gold_dust', '1x ' + SG + ':nether_star_fragment')
    ...
    event.recipes.gtceu.assembler('sg_salvager')
        .itemInputs('1x minecraft:piston', '1x minecraft:iron_block', '2x gtceu:crimson_iron_ingot', '2x #forge:obsidian')
    ...
    event.recipes.gtceu.assembler('sg_material_grader')
        .itemInputs('1x ' + SG + ':advanced_upgrade_base', '3x gtceu:blaze_gold_ingot', '2x #forge:gems/quartz', '2x create:iron_sheet')
        .itemOutputs('1x ' + SG + ':material_grader')
        .duration(12 * 20).EUt(GTValues.VA[GTValues.MV])

    event.remove({ id: SG + ':metal_alloyer' })
    event.recipes.gtceu.assembler('sg_metal_alloyer')
        .itemInputs('2x gtceu:crimson_steel_ingot', '1x minecraft:iron_block', '4x minecraft:blackstone')
    ...
    event.recipes.gtceu.assembler('sg_metal_press')
        .itemInputs('2x gtceu:tyrian_steel_ingot', '4x #forge:obsidian', '2x gtceu:iron_rod')
    ...
    event.recipes.gtceu.assembler('sg_crimson_repair_kit')
        .itemInputs('4x gtceu:crimson_steel_ingot', '1x gtceu:blaze_gold_ingot', '1x minecraft:blaze_rod')
    ...
    event.recipes.gtceu.assembler('sg_azure_repair_kit')
        .itemInputs('4x gtceu:azure_electrum_ingot', '1x #forge:gems/emerald', '1x minecraft:end_rod')
    ...
    event.recipes.gtceu.assembler('sg_recrystallizer')
        .itemInputs('2x gtceu:azure_electrum_ingot', '1x #forge:storage_blocks/gold', '1x #forge:gems/diamond', '1x #forge:gems/emerald', '4x minecraft:purpur_block')
