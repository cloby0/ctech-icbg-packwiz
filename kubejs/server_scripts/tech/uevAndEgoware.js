ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('egoware_processor_assembly_recipe')
        .itemInputs(
            ...
            '32x kubejs:warded_smd_resistor',
            '32x kubejs:warded_smd_inductor',
    ...
    event.recipes.gtceu.assembler('biogenic_synthesis_casing_assembly')
        .itemInputs(
            ...
            '2x kubejs:boundless_astral_ingot',
    ...
    event.recipes.gtceu.assembly_line('artificial_cumium_brain_recipe')
        .itemInputs(
            ...
            '64x kubejs:warded_smd_diode',
            '64x kubejs:warded_smd_capacitor',
            '64x kubejs:warded_smd_transistor',
            '64x kubejs:warded_smd_resistor',
            '64x kubejs:warded_smd_inductor',
            '64x gtceu:ram_chip',
            '16x gtceu:chaotic_singulite_double_wire',
