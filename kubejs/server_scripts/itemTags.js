ServerEvents.tags('item', event => {
  ...
  event.add('kubejs:magic/journeyman', ['kubejs:veridium_filings', 'kubejs:resonant_zanite_crystal', 'aether_redux:veridium_ingot', 'irons_spellbooks:arcane_ingot', 'irons_spellbooks:cinder_essence', 'botania:terrasteel_ingot', 'gtceu:luminessence_dust'])
