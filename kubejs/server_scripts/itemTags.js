ServerEvents.tags('item', event => {
  ...
  event.add('kubejs:magic/arcanist',   ['botania:elementium_ingot', 'kubejs:weak_elementium_dust', 'kubejs:elven_concentrate', 'kubejs:elementite_dust', 'kubejs:glacial_grimoire', 'kubejs:verdant_chronicle'])
  event.add('kubejs:magic/sage',       ['botania:gaia_ingot', 'kubejs:vengeful_gaia_spirit', 'kubejs:soul_of_gaia', 'kubejs:boundless_gaia_spirit_ingot', 'kubejs:gaian_blood_core', 'kubejs:gaian_holy_core', 'kubejs:gaian_void_core', 'kubejs:gaian_annihilation_core', 'kubejs:blood_grimoire', 'kubejs:gaian_sanctum', 'kubejs:abyssal_codex', 'kubejs:obliteration_chronicle'])
});