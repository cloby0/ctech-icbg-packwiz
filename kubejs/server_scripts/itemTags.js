ServerEvents.tags('item', event => {
  ...
  event.add('kubejs:magic/sorcerer',   ['gtceu:prima_materia_ingot', 'aether_redux:gravitite_ingot', 'kubejs:element_attunement_stone', 'kubejs:chaos_essence', 'irons_spellbooks:pyrium_ingot'])
