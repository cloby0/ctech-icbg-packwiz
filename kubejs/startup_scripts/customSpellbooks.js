StartupEvents.registry('item', event => {
    ...
    event.create('pyromatic_codex', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:fire_spell_power', 0.10, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:cooldown_reduction', 0.10, 'MULTIPLY_BASE')
    ...
    event.create('evocation_folio', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:evocation_spell_power', 0.10, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:summon_damage', 0.15, 'MULTIPLY_BASE')
    ...
    event.create('glacial_grimoire', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:ice_spell_power', 0.15, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:mana_regen', 0.15, 'MULTIPLY_BASE')
    ...
    event.create('verdant_chronicle', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:nature_spell_power', 0.15, 'MULTIPLY_BASE')
    ...
    event.create('technomatic_folio', 'irons_spells_js:spellbook')
        ...
        .addAttribute('cataclysm_spellbooks:technomancy_spell_power', 0.15, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:cooldown_reduction', 0.10, 'MULTIPLY_BASE')
    ...
    event.create('blood_grimoire', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:blood_spell_power', 0.25, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:mana_regen', 0.30, 'MULTIPLY_BASE')
    ...
    event.create('radiant_sanctum', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:holy_spell_power', 0.25, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:cast_time_reduction', 0.15, 'MULTIPLY_BASE')
    ...
    event.create('eldritch_codex', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:eldritch_spell_power', 0.25, 'MULTIPLY_BASE')
    ...
    event.create('obliteration_chronicle', 'irons_spells_js:spellbook')
        ...
        .addAttribute('irons_spellbooks:ender_spell_power', 0.25, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:spell_power', 0.10, 'MULTIPLY_BASE')
    ...
    event.create('harbinger_codex', 'irons_spells_js:spellbook')
        ...
        .addAttribute('cataclysm_spellbooks:technomancy_spell_power', 0.35, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:cooldown_reduction', 0.15, 'MULTIPLY_BASE')
        .addAttribute('irons_spellbooks:max_mana', 300.0, 'ADDITION')
