...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('grand_enchanting_sanctum', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle("accccccca", "aaadddaaa", "aaadddaaa", "aaadddaaa", "accccccca", "aabbbbbaa", "aaaaaaaaa", "aaaaaaaaa", "aaaaaaaaa", "aaaaaaaaa")
            ...
            .aisle("bcccccccb", "agfffffda", "adfffffha", "adfffffda", "cccfffccc", "abcfffcba", "aacfffcaa", "aaacfcaaa", "aaabcbaaa", "aaaacaaaa")
            .aisle("bcccccccb", "adfffffda", "adfffffda", "adfffffda", "cccfffccc", "abcfffcba", "aacfffcaa", "aaabcbaaa", "aaaabaaaa", "aaaaaaaaa")
